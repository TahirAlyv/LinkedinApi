        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderProfilePhoto = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_SenderId_ReceiverId_PostId_Type",
                table: "Notifications",
                columns: new[] { "SenderId", "ReceiverId", "PostId", "Type" },
                unique: true,
